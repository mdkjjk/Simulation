...
matplotlib.use('Agg')
input_csv1 = pd.read_csv("./plots_clean/node1500/Original_Entanglement fidelity_2.csv")
input_csv2 = pd.read_csv("./plots_clean/node1500/Filtering_Entanglement fidelity_2.csv")
input_csv3 = pd.read_csv("./plots_clean/node1500/Distil_Entanglement fidelity_2.csv")
input_csv4 = pd.read_csv("./plots_clean/node1500/Distil&Filtering_Entanglement fidelity_2.csv")

input_csv11 = pd.read_csv("./plots_clean/node1500/Original_Teleportation fidelity_2.csv")
input_csv22 = pd.read_csv("./plots_clean/node1500/Filtering_Teleportation fidelity_2.csv")
input_csv33 = pd.read_csv("./plots_clean/node1500/Distil_Teleportation fidelity_2.csv")
input_csv44 = pd.read_csv("./plots_clean/node1500/Distil&Filtering_Teleportation fidelity_2.csv")
